...
<html>
<head>
	<title>CONSULTAR REQUISICION</title>
	<meta charset="utf-8">
...
<body>
    ...
    <form action="../modelo/pagina_buscar_requisicion.php" method="post">
<h1>CONSULTAR REQUISICION</h1>
...
<div class="button"><br><br>
    <button type="submit">Consultar</button> <button type="button" onclick="location.href='logiados_requisicion.php'" >Regresar</button>
    </div>    
</form>